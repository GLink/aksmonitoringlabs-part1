...
Write-Host "Waiting for throttling metrics to appear..."
```
...
$ACTION_GROUP_NAME = "ag-aksmon-$STUDENT_INITIALS"
...
Write-Host "Action Group ID: $ACTION_GROUP_ID"
```
...
- Ensure Prometheus is scraping: `kubectl get pods -n kube-system | Select-String ama-metrics`
