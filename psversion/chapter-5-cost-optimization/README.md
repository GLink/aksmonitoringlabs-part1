...
kubectl get configmap ama-metrics-settings-configmap -n kube-system -o yaml | Select-String interval
...
az group list --output table | Select-String $RESOURCE_GROUP

# Delete local files (optional)
Set-Location ..
Remove-Item -Recurse -Force .\aksmonitoringlabs-part1\
```
